            ...
            <table className='grid'>
                ...
                onChange={handleOnChange}>
                 ...
                 {productsCategory.map((product, index)=>{
                   return <option key={index} value={product.value}>
                    {product.label}
                   </option>
                 })}
                </select>
                ...
                <textarea id='description' placeholder='enter description' name='description' required className='outline-none bg-slate-100 border px-2 py-1 text-md font-light rounded focus:border-slate-300 mb-4' onChange={handleOnChange}>
                </textarea>

                <input type='submit' value='Upload Product' className='w-full bg-[#FE4938] rounded p-1 text-slate-100 cursor-pointer' onClick={handleSubmitproduct}/>
            </table>

            <div className='absolute top-1 right-1 text-2xl text-[#FE4938] p-1 cursor-pointer' onClick={handleCloseUploadProduct}>
            <IoCloseOutline />
            </div>
        </div>
